...
const DashboardMain = lazy(() => import("./pages/DashboardMain.tsx"));
const StudentsPage = lazy(() => import("./pages/StudentsPage.tsx"));
const StudentAnalysis = lazy(() => import("./pages/StudentAnalysis.tsx"));
const RiskAnalysisPage = lazy(() => import("./pages/RiskAnalysisPage.tsx"));
const CounsellingPage = lazy(() => import("./pages/CounsellingPage.tsx"));
